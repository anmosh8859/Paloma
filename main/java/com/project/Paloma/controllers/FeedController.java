...
public class FeedController {
    ...
    public FeedController(PostServices postServices, LoginRepository loginRepository, UserRepository userRepository) {
    ...
    public String showMainPage(ModelMap map){
        ...
        List<Post> posts = postServices.showAllPosts((String) map.get("id"));
